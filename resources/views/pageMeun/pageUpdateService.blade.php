@extends('dashboard')
@section('cont') 
   <form method="POST" action="{{route('serevice.update',['id'=>$data[0]->id])}}" enctype="multipart/form-data">
   @method('patch')
   @csrf
<div class=" justify-content-center" style="margin: 70px 200px;">
            <div class=" d-flex flex-column align-items-center justify-content-center">
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Update an Serevice</h5>
                  ...
                  <form class="row g-3 needs-validation" novalidate="">
                    <div class="col-12">
                      ...
                      <input type="text" name="titre" class="form-control" id="yourTitre"  value="{{$data[0]->titre}}">
                      <div class="invalid-feedback">Please, enter your Titer!</div>
                    </div>
                    <div class="col-12">
                      <label for="yourText" class="form-label pb-0 fs-4">Discriptin :</label><br>
                      <textarea calss="form-control" id="formFile" name="discription" rows="5" cols="60" >{{$data[0]->discription}}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="formFile" name="file" value="{{$data[0]->file}}" />
